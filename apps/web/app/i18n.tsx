...
const messages = {
  en: {
    ...
    "publicStory.slideshowLabel": "{title} slideshow",
    "publicStory.noPublishedPhotos":
      "No published photos are available for slideshow.",
    "publicStory.slideshowControls": "Slideshow controls",
    "publicStory.play": "Play",
    "publicStory.pause": "Pause",
    "publicStory.fullScreen": "Full screen",
    "publicStory.backToStory": "Back to story",
    "publicStory.tripOverview": "Trip overview",
    "publicStory.dayOverview": "Day overview",
    "publicStory.travelPhoto": "{title} travel photo",
    ...
    "story.stopFallback": "Stop {position}",
    "story.areaFallback": "Area {position}",
    "story.mergingStops": "Merging stops...",
    "story.couldNotMergeStops": "Could not merge stops. {error}",
    "story.splittingStop": "Splitting stop...",
    "story.couldNotSplitStop": "Could not split stop. {error}",
    "story.tripOverview": "Trip overview",
    "story.navigateStops": "Navigate stops",
    "story.navigateDays": "Navigate days",
    "story.previousStop": "Previous stop",
    "story.previousDay": "Previous day",
    "story.nextStop": "Next stop",
    "story.nextDay": "Next day",
    "story.travelerCount": "{count} travelers",
    "story.stopCount": "{count} stops",
    "story.tripStats": "{stops} stops · {photos} photos",
    "story.exploreStopsForDay": "Explore stops for {day}",
    "story.showAreaStops": "Show {count} stops in {title}, area {area}",
    "story.areaStopCount": "{title} · {count} stops",
    "story.openStopPhotos": "Open photos for {stop}, stop {position}",
    "story.day": "Day",
    "story.stops": "Stops",
    "story.time": "Time",
    "example.readOnly": "Read-only example",
    "example.title": "Explore a real shared trip",
    "example.description": "See how photos become a map, timeline, and story.",
    "example.backToStart": "Back to start",
    "example.guide": "How to explore this trip",
    "example.exploreMap": "Explore the map",
    "example.exploreMapDescription":
      "Tap a day photo marker to jump into its stops, or select a stop to follow the route.",
    "example.followTimeline": "Follow the timeline",
    "example.followTimelineDescription":
      "See the trip unfold moment by moment.",
    "example.playStory": "Play the story",
    "example.playStoryDescription": "Sit back and relive the journey.",
    "example.frameTitle": "Sample TripWeave story",
    "example.realStory": "This is a real TripWeave story.",
    "example.realStoryDescription":
      "Explore it freely, then create a trip of your own.",
    "example.openNewTab": "Open in a new tab",
    "example.showStop": "Show {stop}",
    "story.empty":
    ...
    "story.dayPhotos": "{date} photos",
    "story.photos": "photos",
    "story.photoCount": "{count} photos",
    "story.tripPhoto": "Trip photo",
    "story.browsePhotosByStop": "Browse photos by stop",
    "story.photosByStop": "Photos by stop",
    "story.closePhotoBrowser": "Close photo browser",
    "story.photoBrowser": "Photo browser",
    "story.loadingPhotos": "Loading photos...",
    "story.noPhotosFound": "No photos found.",
    "story.openPhotoFromStop": "Open photo from {stop}",
    "story.previousPhoto": "Previous photo",
    "story.nextPhoto": "Next photo",
    "story.previewUnavailable": "Preview unavailable",
    ...
    "story.area": "Area {position}",
    "story.areaActions": "Area actions",
    "story.actionsFor": "Actions for {name}",
    "story.stopActions": "Stop actions",
    "story.renameStop": "Rename stop",
    "story.stopName": "Stop name",
    "story.saveStopName": "Save stop name",
    "story.cancelStopRename": "Cancel stop renaming",
    "story.saveStopNote": "Save stop note",
    "story.cancelNoteEditing": "Cancel note editing",
    "story.manageStop": "Manage stop",
    "story.manageNamedStop": "Manage {name}",
    "story.cancelMerge": "Cancel merge",
    "story.mergeWithAnotherStop": "Merge with another stop",
    "story.merge": "Merge",
    "story.cancelSplit": "Cancel split",
    "story.splitStop": "Split stop",
    "story.split": "Split",
    "story.confirmRemove": "Confirm remove",
    "story.removeStopAction": "Remove stop",
    "story.confirmSameStop": "Click the same stop again to confirm.",
    "story.mergeInto": "Merge {source} into {target}",
    "story.confirmMerge": "Confirm merge",
    "story.mergeHere": "Merge here",
    "story.mergeStopWith": "Merge {stop} with:",
    "story.confirmPosition": "Confirm {position}",
    "story.chooseSplitBoundary":
      "Choose the photo boundary where this stop should split.",
    "story.splitAfterPhoto": "Split after photo {position}",
    "story.splitHere": "Split here",
    "story.confirm": "Confirm",
    "story.renameArea": "Rename area",
    "story.manageArea": "Manage area",
    "story.deleteArea": "Delete area",
    "story.areaName": "Area name",
    "story.saveAreaName": "Save area name",
    "story.cancelAreaRename": "Cancel area renaming",
    "story.manageNamedArea": "Manage {name}",
    "story.addBefore": "Add before: {stop}",
    "story.addAfter": "Add after: {stop}",
    "story.removeStop": "Remove {stop}",
  },
  ko: {
    "language.label": "언어",
    "landing.signIn": "로그인",
    ...
    "publicStory.slideshowLabel": "{title} 슬라이드쇼",
    "publicStory.noPublishedPhotos":
      "슬라이드쇼에 표시할 공개 사진이 없습니다.",
    "publicStory.slideshowControls": "슬라이드쇼 제어",
    "publicStory.play": "재생",
    "publicStory.pause": "일시정지",
    "publicStory.fullScreen": "전체 화면",
    "publicStory.backToStory": "이야기로 돌아가기",
    "publicStory.tripOverview": "여행 개요",
    "publicStory.dayOverview": "날짜 개요",
    "publicStory.travelPhoto": "{title} 여행 사진",
    ...
    "story.stopFallback": "장소 {position}",
    "story.areaFallback": "영역 {position}",
    "story.mergingStops": "장소를 병합하는 중...",
    "story.couldNotMergeStops": "장소를 병합할 수 없습니다. {error}",
    "story.splittingStop": "장소를 나누는 중...",
    "story.couldNotSplitStop": "장소를 나눌 수 없습니다. {error}",
    "story.tripOverview": "여행 개요",
    "story.navigateStops": "장소 둘러보기",
    "story.navigateDays": "날짜 둘러보기",
    "story.previousStop": "이전 장소",
    "story.previousDay": "이전 날짜",
    "story.nextStop": "다음 장소",
    "story.nextDay": "다음 날짜",
    "story.travelerCount": "여행자 {count}명",
    "story.stopCount": "장소 {count}곳",
    "story.tripStats": "장소 {stops}곳 · 사진 {photos}장",
    "story.exploreStopsForDay": "{day}의 장소 둘러보기",
    "story.showAreaStops": "{title} 영역 {area}의 장소 {count}곳 보기",
    "story.areaStopCount": "{title} · 장소 {count}곳",
    "story.openStopPhotos": "{stop}의 사진 열기 · 장소 {position}",
    "story.day": "날짜",
    "story.stops": "장소",
    "story.time": "시간",
    "example.readOnly": "읽기 전용 예시",
    "example.title": "실제 함께한 여행 살펴보기",
    "example.description":
      "사진이 지도, 타임라인, 이야기로 완성되는 모습을 확인해 보세요.",
    "example.backToStart": "처음으로 돌아가기",
    "example.guide": "이 여행 둘러보기",
    "example.exploreMap": "지도 둘러보기",
    "example.exploreMapDescription":
      "날짜 사진 마커를 눌러 장소로 이동하거나, 장소를 선택해 경로를 따라가 보세요.",
    "example.followTimeline": "타임라인 따라가기",
    "example.followTimelineDescription": "순간마다 펼쳐지는 여행을 살펴보세요.",
    "example.playStory": "이야기 재생",
    "example.playStoryDescription": "편안히 앉아 여행을 다시 경험해 보세요.",
    "example.frameTitle": "TripWeave 예시 이야기",
    "example.realStory": "실제 TripWeave 이야기입니다.",
    "example.realStoryDescription":
      "자유롭게 둘러본 뒤 나만의 여행을 만들어 보세요.",
    "example.openNewTab": "새 탭에서 열기",
    "example.showStop": "{stop} 보기",
    "story.empty":
      "사진을 추가한 뒤 이야기를 새로고침해 지도와 타임라인을 만드세요.",
    "story.selectedDayControls": "선택한 날짜 제어",
    "story.allDays": "모든 날짜",
    "story.browsePhotos": "{date} 사진 보기",
    "story.dayPhotos": "{date} 사진",
    "story.photos": "사진",
    "story.photoCount": "사진 {count}장",
    "story.tripPhoto": "여행 사진",
    "story.browsePhotosByStop": "장소별 사진 보기",
    "story.photosByStop": "장소별 사진",
    "story.closePhotoBrowser": "사진 탐색기 닫기",
    "story.photoBrowser": "사진 탐색기",
    "story.loadingPhotos": "사진을 불러오는 중...",
    "story.noPhotosFound": "사진을 찾을 수 없습니다.",
    "story.openPhotoFromStop": "{stop}의 사진 열기",
    "story.previousPhoto": "이전 사진",
    "story.nextPhoto": "다음 사진",
    "story.previewUnavailable": "미리보기를 사용할 수 없습니다",
    ...
    "story.addNote": "메모 추가",
    "story.area": "영역 {position}",
    "story.areaActions": "영역 작업",
    "story.actionsFor": "{name} 작업",
    "story.stopActions": "장소 작업",
    "story.renameStop": "장소 이름 변경",
    "story.stopName": "장소 이름",
    "story.saveStopName": "장소 이름 저장",
    "story.cancelStopRename": "장소 이름 변경 취소",
    "story.saveStopNote": "장소 메모 저장",
    "story.cancelNoteEditing": "메모 편집 취소",
    "story.manageStop": "장소 관리",
    "story.manageNamedStop": "{name} 관리",
    "story.cancelMerge": "병합 취소",
    "story.mergeWithAnotherStop": "다른 장소와 병합",
    "story.merge": "병합",
    "story.cancelSplit": "분할 취소",
    "story.splitStop": "장소 분할",
    "story.split": "분할",
    "story.confirmRemove": "제거 확인",
    "story.removeStopAction": "장소 제거",
    "story.confirmSameStop": "같은 장소를 다시 선택해 확인하세요.",
    "story.mergeInto": "{source}을(를) {target}에 병합",
    "story.confirmMerge": "병합 확인",
    "story.mergeHere": "여기에 병합",
    "story.mergeStopWith": "{stop}과(와) 병합:",
    "story.confirmPosition": "{position} 확인",
    "story.chooseSplitBoundary": "이 장소를 나눌 사진 경계를 선택하세요.",
    "story.splitAfterPhoto": "사진 {position} 뒤에서 분할",
    "story.splitHere": "여기서 분할",
    "story.confirm": "확인",
    "story.renameArea": "영역 이름 변경",
    "story.manageArea": "영역 관리",
    "story.deleteArea": "영역 삭제",
    "story.areaName": "영역 이름",
    "story.saveAreaName": "영역 이름 저장",
    "story.cancelAreaRename": "영역 이름 변경 취소",
    "story.manageNamedArea": "{name} 관리",
    "story.addBefore": "앞에 추가: {stop}",
    "story.addAfter": "뒤에 추가: {stop}",
    "story.removeStop": "{stop} 제거",
  },
} as const;
